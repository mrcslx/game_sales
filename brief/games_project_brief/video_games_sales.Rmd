...
There's four datasets you can use. The first is a more up to date dataset with basic information on the top selling games is found in 'sales-2019.csv'. It contains the following variables:
...
The last two datasets "xbox-one-game-sales.csv" and "ps4-game-sales.csv" contain information specific to those two consoles. The information may overlap with what is available in the other data sets. You have to decide how to use this data, if you use it at all. 
