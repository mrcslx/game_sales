...
with pc_data_container:
    ...
    pc = pd.read_csv('/Users/marcuseilertsen/CodeClan/game_sales/dashboard/sales-pc.csv')
...
with ps4_data_container:
    ...
    ps4 = pd.read_csv('/Users/marcuseilertsen/CodeClan/game_sales/dashboard/sales-ps4.csv')
...
with xbox_data_container:
    ...
    xbox = pd.read_csv('/Users/marcuseilertsen/CodeClan/game_sales/dashboard/sales-xbox.csv')
